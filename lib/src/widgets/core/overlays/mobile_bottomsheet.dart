    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: _podCtr.vimeoOrVideoUrls
            .map(
              (e) => ListTile(
                title: Text('${e.quality}p',style: TextStyle(fontSize: 20,color: Colors.black),),
                onTap: () {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: _podCtr.videoPlaybackSpeeds
            .map(
              (e) => ListTile(
                title: Text(e,style: TextStyle(fontSize: 20,color: Colors.black),),
                onTap: () {
                  onTap != null ? onTap!() : Navigator.of(context).pop();
...
class _MobileOverlayBottomControlles extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const durationTextStyle = TextStyle(color: Colors.white70,fontSize: 18);
                  ...
                  return Row(
                    children: [
                      Text(
                        ...
                        style: const TextStyle(color: itemColor,fontSize: 18),
                      ),
                      const Text(
                        ' / ',
